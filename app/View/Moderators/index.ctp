<div class="moderators index">
	...
	<tr>
		...
		<td><?php echo h($moderator['Moderator']['active']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $moderator['Moderator']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $moderator['Moderator']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $moderator['Moderator']['id']), array(), __('Are you sure you want to delete # %s?', $moderator['Moderator']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
