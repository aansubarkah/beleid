...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('List Moderators'), array('controller' => 'moderators', 'action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Moderator'), array('controller' => 'moderators', 'action' => 'add')); ?> </li>
